...
file2read = ['TestSet/Goal_inpaint.png'];
I0 = imread(file2read);
...
%try several values
mask_extended(dist<=60 & mask~=1) = 1; % The added area  where graphical model will be applied 
...
similar_images = find_similar_images(I0,mask,Nresults,'descriptorsGIST.mat');
